...
const ToogleData = ({ getSmallData, getBigData }) => {
    ...
    return (
        <div className="container__toogle-data">
            <button className="button button--select-data" onClick={ getSmall }>SMALL DATA</button>
            <button className="button button--select-data" onClick={ getBig }>BIG DATA</button>
        </div>
    );
};
